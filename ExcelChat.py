...
IMPORTANT MATPLOTLIB RULES:
- DO NOT use `matplotlib.cm.get_cmap()`, as it has been removed. Use `plt.get_cmap()` or `matplotlib.colormaps[name]` instead.
- For visualizations, always return a Matplotlib figure object.
...
"""
    ...
    # Updated to the currently supported models
    models_to_try = ["gemini-3.5-flash", "gemini-2.5-flash"]
    errors = []

    for model_name in models_to_try:
        try:
            # Append the API key directly to the URL as a query parameter
